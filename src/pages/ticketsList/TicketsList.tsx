      ...
      {isLoading ? (
        ...
        <div className="w-full px-14 pt-8">
          ...
          <div className="flex flex-col overflow-y-auto rounded-lg bg-white p-3 shadow-customLg">
            ...
            {data?.map((item: ISendTicketProps) => {
              return (
                <div
                  key={item.id}
                ...
                >
                  ...
                  <div className="flex items-center">
                    <Image src={item.status === "answerd" ? tic : wait} width="16" height="16" alt="Icon" />{" "}
                    <span className="px-2">{item.status === "answerd" ? "پاسخ داده شده" : "در انتظار پاسخ"}</span>
                  </div>
                  <div
